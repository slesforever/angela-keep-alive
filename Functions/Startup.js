...
function rarityLabel(rarity) {
    return ({ 'Color Fixer':'👑 Color Fixer','Special':'🌀 Special','0000':'✨ ★★★★','Egos':'🔮 E.G.O','000':'★★★','00':'★★','0':'★' })[rarity] || rarity;
}
...
async function announceCurrentRateUps(botClient) {
    ...
    } catch (err) { console.error('Rate Up 公告失敗:', err.message); }
}
...
client.once('clientReady', async () => {
    ...
    } catch (err) { console.error('❌ 上線報告失敗:', err.message); }
